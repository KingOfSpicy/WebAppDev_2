...
namespace CheWei_WAD_Task3.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(CheWei_WAD_Task3Context context)
        {
            _context = context;
        }
        ...
        {
            var cheWei_WAD_Task3Context = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
            return View(await cheWei_WAD_Task3Context.ToListAsync());
        }
